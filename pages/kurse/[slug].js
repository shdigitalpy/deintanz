...
// Function to convert multi-line text to HTML
const convertMultiLineTextToHTML = async (multiLineText) => {
  const result = await remark().use(remarkHTML).process(multiLineText);
    ...
    <>
      <Layout>
        ...
        <TanzStundeDetailsDynamic
          ...
          description={kurse.description ? kurse.description.raw : null}
          image={kurse.tanzstundeImage.url ? kurse.tanzstundeImage.url : null}
